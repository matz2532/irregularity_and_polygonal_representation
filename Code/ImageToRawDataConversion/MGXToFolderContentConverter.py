...
if __name__ == '__main__':
    ...
    # addGeometricDataFilenameAndKey("Images/full cotyledons/full cotyledons_multiFolderContent.pkl", geometricTableBaseName="{}_geometricData no stomata.csv", timePointInPath=False)
    # addGeometricDataFilenameAndKey("Images/Matz2022SAM_multiFolderContent.pkl", seperator="", geometricTableBaseName="area{}.csv", polygonGeometricTableBaseName="area{} poly.csv")
